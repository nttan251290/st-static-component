...
(function (b, a) {
  ...
  bP.extend({
    ...
    isPlainObject: function (ce) {
      ...
      try {
        if (
          ce.constructor &&
          !R.call(ce, "constructor") &&
          !R.call(ce.constructor.prototype, "isPrototypeOf")
        ) {
          return false;
        }
      } catch (cd) {
  ...
  function aB(ce) {
    var cd = !!ce && "length" in ce && ce.length,
      i = bP.type(ce);
    ...
    return (
      i === "array" ||
      cd === 0 ||
      (typeof cd === "number" && cd > 0 && cd - 1 in ce)
    );
  }
  var l =
    /*!
    ...
    (function (dk) {
      var cE,
        ...
        c7 = /[+~]/,
        cT = /'|\\/g,
        cy = new RegExp("\\\\([\\da-f]{1,6}" + cv + "?|(" + cv + ")|.)", "ig"),
        db = function (i, dw, du) {
          var dv = "0x" + dw - 65536;
          return dv !== dv || du
            ? dw
            : dv < 0
            ? String.fromCharCode(dv + 65536)
            : String.fromCharCode((dv >> 10) | 55296, (dv & 1023) | 56320);
        },
        ds = function () {
          c5();
        };
            ...
            if (dD !== 11 && (dG = cX.exec(dB))) {
              if ((dz = dG[1])) {
                ...
                if (dG[2]) {
                  ...
                  if (
                    (dz = dG[3]) &&
                    dn.getElementsByClassName &&
                    dv.getElementsByClassName
                  ) {
      ...
      function cg(du, i) {
        var dw = i && du,
          dv =
            ...
            du.nodeType === 1 &&
            i.nodeType === 1 &&
            (~i.sourceIndex || cW) - (~du.sourceIndex || cW);
        if (dv) {
          return dv;
        }
        if (dw) {
      ...
      c5 = cC.setDocument = function (dv) {
        ...
        if (dn.getById) {
          ...
          ct.filter.ID = function (dy) {
            ...
            return function (dA) {
              var dz =
                typeof dA.getAttributeNode !== "undefined" &&
                dA.getAttributeNode("id");
              return dz && dz.value === dx;
            };
          };
        }
        ct.find.TAG = dn.getElementsByTagName
          ? function (dx, dy) {
        ...
        if (
          (dn.matchesSelector = cV.test(
            (ck =
              cu.matches ||
              cu.webkitMatchesSelector ||
              cu.mozMatchesSelector ||
              cu.oMatchesSelector ||
              cu.msMatchesSelector)
          ))
        ) {
          cl(function (dx) {
        ...
        cL =
          i || cV.test(cu.contains)
            ? function (dy, dx) {
                var dA = dy.nodeType === 9 ? dy.documentElement : dy,
                  dz = dx && dx.parentNode;
                return (
                  dy === dz ||
                  !!(
                    ...
                    (dA.contains
                      ? dA.contains(dz)
                      : dy.compareDocumentPosition &&
                        dy.compareDocumentPosition(dz) & 16)
                  )
                );
              }
            : function (dy, dx) {
        ...
        cK = i
          ? function (dy, dx) {
              ...
              var dz =
                !dy.compareDocumentPosition - !dx.compareDocumentPosition;
              if (dz) {
                return dz;
              }
              dz =
                (dy.ownerDocument || dy) === (dx.ownerDocument || dx)
                  ? dy.compareDocumentPosition(dx)
                  : 1;
              if (
                dz & 1 ||
                (!dn.sortDetached && dx.compareDocumentPosition(dy) === dz)
              ) {
      ...
      cC.matchesSelector = function (du, dw) {
        ...
        if (
          ...
          try {
            ...
            if (
              i ||
              dn.disconnectedMatch ||
              (du.document && du.document.nodeType !== 11)
            ) {
              return i;
            }
          } catch (dv) {}
      ...
      cC.attr = function (dv, i) {
        ...
        var du = ct.attrHandle[i.toLowerCase()],
          dw =
            du && cU.call(ct.attrHandle, i.toLowerCase())
              ? du(dv, i, !de)
              : undefined;
        return dw !== undefined
          ? dw
          : dn.attributes || !de
          ? dv.getAttribute(i)
          : (dw = dv.getAttributeNode(i)) && dw.specified
          ? dw.value
          : null;
      };
      cC.error = function (i) {
      ...
      ct = cC.selectors = {
          ...
          PSEUDO: function (du) {
            ...
            if (du[3]) {
              ...
              if (
                ...
                cY.test(dv) &&
                (i = cn(dv, true)) &&
                (i = dv.indexOf(")", dv.length - i) - dv.length)
              ) {
                du[0] = du[0].slice(0, i);
                du[2] = dv.slice(0, i);
              }
        ...
        filter: {
          ...
          CLASS: function (i) {
            ...
            return (
              du ||
              ((du = new RegExp("(^|" + cv + ")" + i + "(" + cv + "|$)")) &&
                cf(i, function (dv) {
                  return du.test(
                    (typeof dv.className === "string" && dv.className) ||
                      (typeof dv.getAttribute !== "undefined" &&
                        dv.getAttribute("class")) ||
                      ""
                  );
                }))
            );
          ...
          ATTR: function (dv, du, i) {
            return function (dx) {
              ...
              return du === "="
                ...
                ? i && dw.indexOf(i) > -1
                : du === "$="
                ? i && dw.slice(-i.length) === i
                : du === "~="
                ? (" " + dw.replace(cA, " ") + " ").indexOf(i) > -1
                : du === "|="
                ? dw === i || dw.slice(0, i.length + 1) === i + "-"
                : false;
            };
          },
          CHILD: function (du, dx, dw, dy, dv) {
            var dA = du.slice(0, 3) !== "nth",
              i = du.slice(-4) !== "last",
              dz = dx === "of-type";
            return dy === 1 && dv === 0
              ? function (dB) {
              ...
              : function (dI, dG, dL) {
                  var dB,
                    ...
                    dK,
                    dF,
                    dH = dA !== i ? "nextSibling" : "previousSibling",
                    dN = dI.parentNode,
                    dD = dz && dI.nodeName.toLowerCase(),
                    dC = !dL && !dz,
                    dM = false;
                  if (dN) {
                    if (dA) {
          ...
          PSEUDO: function (dw, dv) {
            var i,
              du =
                ct.pseudos[dw] ||
                ct.setFilters[dw.toLowerCase()] ||
                cC.error("unsupported pseudo: " + dw);
            if (du[dg]) {
              return du(dv);
            }
            if (du.length > 1) {
              i = [dw, dw, "", dv];
              return ct.setFilters.hasOwnProperty(dw.toLowerCase())
                ? cp(function (dz, dB) {
                    var dy,
                      dx = du(dz, dv),
                      dA = dx.length;
        ...
        pseudos: {
          not: cp(function (i) {
            var du = [],
              dv = [],
              dw = c2(i.replace(cx, "$1"));
            return dw[dg]
              ? cp(function (dy, dD, dB, dz) {
                  var dC,
                    dx = dw(dy, null, dz, []),
                    dA = dy.length;
                  while (dA--) {
            ...
            return function (dv) {
              ...
              do {
                if (
                  (du = de
                    ? dv.lang
                    : dv.getAttribute("xml:lang") || dv.getAttribute("lang"))
                ) {
                  du = du.toLowerCase();
          ...
          text: function (du) {
            var i;
            return (
              du.nodeName.toLowerCase() === "input" &&
              du.type === "text" &&
              ((i = du.getAttribute("type")) == null ||
                i.toLowerCase() === "text")
            );
          },
          first: dd(function () {
        ...
        var dv,
          ...
          du = [
            function (dH, dG, dF) {
              var i =
                (!dD && (dF || dG !== dt)) ||
                ((dv = dG).nodeType ? dB(dH, dG, dF) : dC(dH, dG, dF));
              dv = null;
              return i;
            },
          ];
              ...
              return cm(
                ...
                dx > 1 &&
                  co(
                    dA
                      .slice(0, dx - 1)
                      .concat({ value: dA[dx - 2].type === " " ? "*" : "" })
                  ).replace(cx, "$1"),
                dy,
                dx < dw && dh(dA.slice(dx, dw)),
                dw < dz && dh((dA = dA.slice(dw))),
                dw < dz && co(dA)
              );
            }
            du.push(dy);
        ...
        var i = dv.length > 0,
          ...
          du = function (dH, dB, dG, dF, dK) {
            var dC,
              ...
              dN = [],
              dL = dt,
              dA = dH || (dx && ct.find.TAG("*", dK)),
              dz = (dp += dL == null ? 1 : Math.random() || 0.1),
              dJ = dA.length;
            if (dK) {
              dt = dB === cI || dB || dK;
            }
      ...
      dm = cC.select = function (dw, du, dx, dA) {
        var dy,
          ...
          dE,
          dB,
          dC = typeof dw === "function" && dw,
          dz = !dA && cn((dw = dC.selector || dw));
        dx = dx || [];
        if (dz.length === 1) {
          ...
          while (dy--) {
            ...
            if ((dB = ct.find[dE])) {
              if (
                (dA = dB(
                  dv.matches[0].replace(cy, db),
                  (c7.test(dD[0].type) && cZ(du.parentNode)) || du
                ))
              ) {
                dD.splice(dy, 1);
                dw = dA.length && co(dD);
        ...
        (dC || c2(dw, dz))(
          ...
          !de,
          dx,
          !du || (c7.test(dw) && cZ(du.parentNode)) || du
        );
        return dx;
      };
      ...
      if (
        ...
        dq(ce, function (du, i, dw) {
          ...
          if (!dw) {
            return du[i] === true
              ? i.toLowerCase()
              : (dv = du.getAttributeNode(i)) && dv.specified
              ? dv.value
              : null;
          }
        });
  ...
  bP.filter = function (cf, i, ce) {
    ...
    return i.length === 1 && cd.nodeType === 1
      ? bP.find.matchesSelector(cd, cf)
        ? [cd]
        : []
      : bP.find.matches(
          cf,
          bP.grep(i, function (cg) {
  ...
  bP.fn.extend({
    ...
    is: function (i) {
      return !!aY(
        this,
        typeof i === "string" && z.test(i) ? bP(i) : i || [],
        false
      ).length;
    },
  });
  var y,
    bA = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]*))$/,
    b3 = (bP.fn.init = function (i, cf, cd) {
      var ce, cg;
      if (!i) {
        return this;
      }
        ...
        if (ce && (ce[1] || !cf)) {
          if (ce[1]) {
            ...
            bP.merge(
              ...
              bP.parseHTML(
                ce[1],
                cf && cf.nodeType ? cf.ownerDocument || cf : m,
                true
              )
            );
  ...
  b3.prototype = bP.fn;
  y = bP(m);
  var bC = /^(?:parents|prev(?:Until|All))/,
    bG = { children: true, contents: true, next: true, prev: true };
  bP.fn.extend({
    has: function (cg) {
      var cf,
        ce = bP(cg, this),
    ...
    closest: function (ch, cg) {
      var ci,
        ...
        cd = [],
        cj =
          z.test(ch) || typeof ch !== "string" ? bP(ch, cg || this.context) : 0;
      for (; cf < ce; cf++) {
        for (ci = this[cf]; ci && ci !== cg; ci = ci.parentNode) {
          if (
            ...
            (cj
              ? cj.index(ci) > -1
              : ci.nodeType === 1 && bP.find.matchesSelector(ci, ch))
          ) {
            cd.push(ci);
            break;
          }
  ...
  bP.each(
    {
      ...
      contents: function (i) {
        return bP.nodeName(i, "iframe")
          ? i.contentDocument || i.contentWindow.document
          : bP.merge([], i.childNodes);
      },
    },
    function (i, cd) {
  ...
  bP.extend({
    Deferred: function (ce) {
      var cd = [
          ["resolve", "done", bP.Callbacks("once memory"), "resolved"],
          ["reject", "fail", bP.Callbacks("once memory"), "rejected"],
          ["notify", "progress", bP.Callbacks("memory")],
        ],
        cf = "pending",
        cg = {
          state: function () {
    ...
    when: function (ch) {
      var cf = 0,
        cj = X.call(arguments),
        cd = cj.length,
        ce = cd !== 1 || (ch && bP.isFunction(ch.promise)) ? cd : 0,
        cm = ce === 1 ? ch : bP.Deferred(),
  ...
  var V = function (ce) {
    var cd = bP.noData[(ce.nodeName + " ").toLowerCase()],
      i = +ce.nodeType || 1;
    return i !== 1 && i !== 9
      ? false
      : !cd || (cd !== true && ce.getAttribute("classid") === cd);
  };
  var bF = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/,
    aX = /([A-Z])/g;
  ...
  function bj(cf, cd, ch, cg) {
    ...
    var cj,
      ...
      cl = cf.nodeType,
      i = cl ? bP.cache : cf,
      ce = cl ? cf[ck] : cf[ck] && ck;
    if (
      (!ce || !i[ce] || (!cg && !i[ce].data)) &&
      ch === undefined &&
      typeof cd === "string"
    ) {
      return;
  ...
  function aj(ch, cf, cd) {
    ...
    var cj,
      ...
      ci = ch.nodeType,
      ce = ci ? bP.cache : ch,
      ck = ci ? ch[bP.expando] : bP.expando;
    if (!ce[ck]) {
      return;
    }
    if (cf) {
  ...
  bP.extend({
    ...
    dequeue: function (ch, cg) {
      cg = cg || "fx";
      var cd = bP.queue(ch, cg),
        ci = cd.length,
        cf = cd.shift(),
        i = bP._queueHooks(ch, cg),
        ce = function () {
          bP.dequeue(ch, cg);
        };
      if (cf === "inprogress") {
  ...
  var aa = function (cd, i) {
    cd = i || cd;
    return (
      bP.css(cd, "display") === "none" || !bP.contains(cd.ownerDocument, cd)
    );
  };
  ...
  (function () {
    ...
    F.html5Clone =
      m.createElement("nav").cloneNode(true).outerHTML !== "<:nav></:nav>";
    i.type = "checkbox";
    i.checked = true;
    cd.appendChild(i);
  ...
  function k(cg, cd) {
    var ce,
      ...
      cf = 0,
      ci =
        typeof cg.getElementsByTagName !== "undefined"
          ? cg.getElementsByTagName(cd || "*")
          : typeof cg.querySelectorAll !== "undefined"
          ? cg.querySelectorAll(cd || "*")
          : undefined;
    if (!ci) {
    ...
    return cd === undefined || (cd && bP.nodeName(cg, cd))
      ? bP.merge([cg], ci)
      : ci;
  }
  function bB(cd, cf) {
          ...
          if (!S.test(ci)) {
            ...
            if (!F.tbody) {
              ci =
                cs === "table" && !b8.test(ci)
                  ? cq.firstChild
                  : cf[1] === "<table>" && !b8.test(ci)
                  ? cq
                  : 0;
              cn = ci && ci.childNodes.length;
              while (cn--) {
                if (
                  bP.nodeName((cp = ci.childNodes[cn]), "tbody") &&
                  !cp.childNodes.length
                ) {
                  ci.removeChild(cp);
                }
              }
  ...
  var bN = /^(?:input|select|textarea)$/i,
    bd = /^key/,
    bS = /^(?:mouse|pointer|contextmenu|drag|drop)|click/,
    bJ = /^(?:focusinfocus|focusoutblur)$/,
    bE = /^([^.]*)(?:\.(.+)|)/;
  function ac() {
    return true;
  }
  ...
  bP.event = {
    ...
    add: function (cg, cl, cq, ci, ch) {
      ...
      if (!(ck = cm.handle)) {
        ck = cm.handle = function (ct) {
          return typeof bP !== "undefined" &&
            (!ct || bP.event.triggered !== ct.type)
            ? bP.event.dispatch.apply(ck.elem, arguments)
            : undefined;
        };
        ck.elem = cg;
      }
      ...
      while (cr--) {
        ...
        while (ci--) {
          ...
          if (
            (ck || cd === cp.origType) &&
            (!cs || cs.guid === cp.guid) &&
            (!cj || cj.test(cp.namespace)) &&
            (!cg || cg === cp.selector || (cg === "**" && cp.selector))
          ) {
            ce.splice(ci, 1);
            if (cp.selector) {
              ce.delegateCount--;
    ...
    trigger: function (cd, ck, cg, cr) {
      ...
      if (!cr && !cd.isDefaultPrevented()) {
        if (
          (!cn._default || cn._default.apply(ch.pop(), ck) === false) &&
          V(cg)
        ) {
    ...
    dispatch: function (cd) {
      ...
      var ch,
        ...
        cl = [],
        ck = X.call(arguments),
        cf = (bP._data(this, "events") || {})[cd.type] || [],
        cj = bP.event.special[cd.type] || {};
      ck[0] = cd;
      ...
      while ((ce = cl[ch++]) && !cd.isPropagationStopped()) {
        ...
        while (
          (cm = ce.handlers[cg++]) &&
          !cd.isImmediatePropagationStopped()
        ) {
          if (!cd.rnamespace || cd.rnamespace.test(cm.namespace)) {
            cd.handleObj = cm;
            cd.data = cm.data;
            ci = (
              (bP.event.special[cm.origType] || {}).handle || cm.handler
            ).apply(ce.elem, ck);
            if (ci !== undefined) {
    ...
    handlers: function (cd, cf) {
      ...
      if (
        cg &&
        cl.nodeType &&
        (cd.type !== "click" || isNaN(cd.button) || cd.button < 1)
      ) {
        for (; cl != this; cl = cl.parentNode || this) {
          if (
            cl.nodeType === 1 &&
            (cl.disabled !== true || cd.type !== "click")
          ) {
            ci = [];
            for (ch = 0; ch < cg; ch++) {
              ck = cf[ch];
              ce = ck.selector + " ";
              if (ci[ce] === undefined) {
                ci[ce] = ck.needsContext
                  ? bP(ce, this).index(cl) > -1
                  : bP.find(ce, this, null, [cl]).length;
              }
              if (ci[ce]) {
                ci.push(ck);
              }
    ...
    fix: function (cg) {
      ...
      var ce,
        ...
        ch = this.fixHooks[cf];
      if (!ch) {
        this.fixHooks[cf] = ch = bS.test(cf)
          ? this.mouseHooks
          : bd.test(cf)
          ? this.keyHooks
          : {};
    ...
    mouseHooks: {
      ...
      filter: function (cf, ce) {
        ...
        if (cf.pageX == null && ce.clientX != null) {
          ...
          cf.pageX =
            ce.clientX +
            ((ch && ch.scrollLeft) || (i && i.scrollLeft) || 0) -
            ((ch && ch.clientLeft) || (i && i.clientLeft) || 0);
          cf.pageY =
            ce.clientY +
            ((ch && ch.scrollTop) || (i && i.scrollTop) || 0) -
            ((ch && ch.clientTop) || (i && i.clientTop) || 0);
        }
  ...
  bP.removeEvent = m.removeEventListener
    ? function (cd, i, ce) {
  ...
  bP.Event = function (cd, i) {
    ...
    if (cd && cd.type) {
      ...
      this.isDefaultPrevented =
        cd.defaultPrevented ||
        (cd.defaultPrevented === undefined && cd.returnValue === false)
          ? ac
          : ah;
    } else {
      this.type = cd;
    ...
    bP.event.special.submit = {
      setup: function () {
        ...
        bP.event.add(this, "click._submit keypress._submit", function (ce) {
          var cd = ce.target,
            i =
              bP.nodeName(cd, "input") || bP.nodeName(cd, "button")
                ? bP.prop(cd, "form")
                : undefined;
  ...
  if (!F.focusin) {
    bP.each({ focus: "focusin", blur: "focusout" }, function (ce, i) {
      ...
      bP.event.special[i] = {
        setup: function () {
          var cg = this.ownerDocument || this,
            cf = bP._data(cg, i);
          if (!cf) {
  ...
  bP.fn.extend({
    ...
    off: function (ce, i, cg) {
      ...
      if (ce && ce.preventDefault && ce.handleObj) {
        cd = ce.handleObj;
        bP(ce.delegateTarget).off(
          cd.namespace ? cd.origType + "." + cd.namespace : cd.origType,
          cd.selector,
          cd.handler
        );
        return this;
  ...
  var aK = / jQuery\d+="(?:null|\d+)"/g,
    ...
    b4 = /checked\s*(?:[^=]|=\s*.checked.)/i,
    az = /^true\/(.*)/,
    aU = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,
    a0 = C(m),
    j = a0.appendChild(m.createElement("div"));
  function ba(cd, i) {
    return bP.nodeName(cd, "table") &&
      bP.nodeName(i.nodeType !== 11 ? i : i.firstChild, "tr")
      ? cd.getElementsByTagName("tbody")[0] ||
          cd.appendChild(cd.ownerDocument.createElement("tbody"))
      : cd;
  }
  function u(i) {
  ...
  function J(cl, cn, cr, cg) {
    ...
    if (
      ce ||
      (ch > 1 && typeof co === "string" && !F.checkClone && b4.test(co))
    ) {
          ...
          for (cj = 0; cj < cd; cj++) {
            ...
            if (
              ...
              if (cf.src) {
                ...
                bP.globalEval(
                  (cf.text || cf.textContent || cf.innerHTML || "").replace(
                    aU,
                    ""
                  )
                );
  ...
  bP.extend({
    ...
    clone: function (ce, cg, cd) {
      var ci,
        ...
        ch,
        cj,
        ck = bP.contains(ce.ownerDocument, ce);
      ...
      return aJ(
        ...
        function (cd) {
          return cd === undefined
            ? bP.text(this)
            : this.empty().append(
                ((this[0] && this[0].ownerDocument) || m).createTextNode(cd)
              );
        },
        null,
        i,
      ...
      return aJ(
        ...
        function (cg) {
          ...
          if (
            typeof cg === "string" &&
            !av.test(cg) &&
            (F.htmlSerialize || !T.test(cg)) &&
            (F.leadingWhitespace || !cc.test(cg)) &&
            !ad[(n.exec(cg) || ["", ""])[1].toLowerCase()]
          ) {
  ...
  var aO,
    bs = { HTML: "block", BODY: "block" };
  function bb(i, cf) {
    var cd = bP(cf.createElement(i)).appendTo(cf.body),
      ce = bP.css(cd[0], "display");
    cd.detach();
    return ce;
  }
  function a8(ce) {
    ...
    if (!i) {
      ...
      if (i === "none" || !i) {
        aO = (
          aO || bP("<iframe frameborder='0' width='0' height='0'/>")
        ).appendTo(cd.documentElement);
  ...
  (function () {
    ...
    F.boxSizing =
      i.style.boxSizing === "" ||
      i.style.MozBoxSizing === "" ||
      i.style.WebkitBoxSizing === "";
    bP.extend(F, {
    ...
    function cg() {
      ...
      if (bc.getComputedStyle) {
        ...
        cm.style.cssText = i.style.cssText =
  ...
  var bq = /alpha\([^)]*\)/i,
    ...
    bK = { letterSpacing: "0", fontWeight: "400" },
    aE = ["Webkit", "O", "Moz", "ms"],
  ...
  function c(cd) {
    ...
    var cf = cd.charAt(0).toUpperCase() + cd.slice(1),
      ce = aE.length;
    while (ce--) {
      cd = aE[ce] + cf;
      if (cd in bY) {
  ...
  function aF(ch, ce, cd, cj, cg) {
    var cf = cd === (cj ? "border" : "content") ? 4 : ce === "width" ? 1 : 0,
      ci = 0;
    for (; cf < 4; cf += 2) {
      if (cd === "margin") {
  ...
  function v(cg, cd, i) {
    var cf = true,
      ch = cd === "width" ? cg.offsetWidth : cg.offsetHeight,
      ce = bx(cg),
  ...
  bP.each(["height", "width"], function (ce, cd) {
    bP.cssHooks[cd] = {
      get: function (cg, cf, i) {
        if (cf) {
          return M.test(bP.css(cg, "display")) && cg.offsetWidth === 0
            ? K(cg, bl, function () {
                return v(cg, cd, i);
              })
            : v(cg, cd, i);
        ...
        return aT(
          ...
          i
            ? aF(
                ...
                i,
                F.boxSizing &&
                  bP.css(cg, "boxSizing", false, cf) === "border-box",
                cf
              )
            : 0
        );
  ...
  if (!F.opacity) {
    bP.cssHooks.opacity = {
      get: function (cd, i) {
        return a2.test(
          (i && cd.currentStyle ? cd.currentStyle.filter : cd.style.filter) ||
            ""
        )
      ...
      set: function (cg, ch) {
        var cf = cg.style,
          cd = cg.currentStyle,
          i = bP.isNumeric(ch) ? "alpha(opacity=" + ch * 100 + ")" : "",
          ce = (cd && cd.filter) || cf.filter || "";
        cf.zoom = 1;
        if (
          (ch >= 1 || ch === "") &&
          bP.trim(ce.replace(bq, "")) === "" &&
          cf.removeAttribute
        ) {
  ...
  bP.cssHooks.marginLeft = be(F.reliableMarginLeft, function (cd, i) {
    if (i) {
      return (
        (parseFloat(I(cd, "marginLeft")) ||
          (bP.contains(cd.ownerDocument, cd)
            ? cd.getBoundingClientRect().left -
              K(cd, { marginLeft: 0 }, function () {
  ...
  bP.each({ margin: "", padding: "", border: "Width" }, function (i, cd) {
    bP.cssHooks[i + cd] = {
      expand: function (cg) {
        var cf = 0,
          ce = {},
          ch = typeof cg === "string" ? cg.split(" ") : [cg];
        for (; cf < 4; cf++) {
  ...
  P.prototype = {
    constructor: P,
    init: function (cf, cd, ch, i, cg, ce) {
      this.elem = cf;
      this.prop = ch;
    ...
    run: function (ce) {
      ...
      if (this.options.duration) {
        this.pos = cd = bP.easing[this.easing](
          ce,
          this.options.duration * ce,
          0,
          1,
  ...
  P.propHooks = {
    _default: {
      get: function (cd) {
        ...
        if (
          cd.elem.nodeType !== 1 ||
          (cd.elem[cd.prop] != null && cd.elem.style[cd.prop] == null)
        ) {
      ...
      set: function (i) {
        if (bP.fx.step[i.prop]) {
          ...
          if (
            i.elem.nodeType === 1 &&
            (i.elem.style[bP.cssProps[i.prop]] != null || bP.cssHooks[i.prop])
          ) {
  ...
  function bk(cg, ci, cf) {
    var cd,
      ch = (e.tweeners[ci] || []).concat(e.tweeners["*"]),
      i = 0,
      ce = ch.length;
    for (; i < ce; i++) {
  ...
  function e(ce, ci, cl) {
    var cm,
      i,
      ch = 0,
      cd = e.prefilters.length,
      ck = bP.Deferred().always(function () {
        delete cg.elem;
      }),
      cg = function () {
        if (i) {
        ...
        var cs = U || bu(),
          cp = Math.max(0, cf.startTime + cf.duration - cs),
          cn = cp / cf.duration || 0,
          cr = 1 - cn,
          co = 0,
          cq = cf.tweens.length;
      ...
      cf = ck.promise({
        ...
        opts: bP.extend(
          true,
          { specialEasing: {}, easing: bP.easing._default },
          cl
        ),
        ...
        createTween: function (cp, cn) {
          var co = bP.Tween(
            ...
            cp,
            cn,
            cf.opts.specialEasing[cp] || cf.opts.easing
          );
          cf.tweens.push(co);
          return co;
        },
    ...
    return cf
      .progress(cf.opts.progress)
      .done(cf.opts.done, cf.opts.complete)
      .fail(cf.opts.fail)
      .always(cf.opts.always);
  }
  ...
  bP.speed = function (ce, cf, cd) {
    ...
    i.duration = bP.fx.off
      ? 0
      : typeof i.duration === "number"
      ? i.duration
      : i.duration in bP.fx.speeds
      ? bP.fx.speeds[i.duration]
  ...
  bP.fn.extend({
    fadeTo: function (i, cf, ce, cd) {
      return this.filter(aa)
        ...
        .show()
        .end()
        .animate({ opacity: cf }, i, ce, cd);
    },
    animate: function (ci, cf, ch, cg) {
      var ce = bP.isEmptyObject(ci),
        i = bP.speed(cf, ch, cg),
        cd = function () {
  ...
  bP.each(["toggle", "show", "hide"], function (ce, cd) {
    ...
    bP.fn[cd] = function (i, ch, cg) {
      return i == null || typeof i === "boolean"
        ...
        : this.animate(bO(cd, true), i, ch, cg);
    };
  });
  bP.each(
    {
      ...
      select: {
        get: function (cd) {
          var cj,
            ...
            cl = cd.options,
            ch = cd.selectedIndex,
            cg = cd.type === "select-one" || ch < 0,
            ck = cg ? null : [],
            ci = cg ? ch + 1 : cl.length,
            ce = ch < 0 ? ci : cg ? ch : 0;
          for (; ce < ci; ce++) {
            cf = cl[ce];
            if (
              ...
              (F.optDisabled
                ? !cf.disabled
                : cf.getAttribute("disabled") === null) &&
              (!cf.parentNode.disabled ||
                !bP.nodeName(cf.parentNode, "optgroup"))
            ) {
              cj = bP(cf).val();
              if (cg) {
                return cj;
    ...
    propHooks: {
      tabIndex: {
        get: function (cd) {
          ...
          return i
            ? parseInt(i, 10)
            : aP.test(cd.nodeName) || (H.test(cd.nodeName) && cd.href)
            ? 0
            : -1;
        },
      },
        ...
        if (cd === "string") {
          ...
          if (ce === undefined || cd === "boolean") {
            ...
            bP.attr(
              this,
              "class",
              ch || ce === false ? "" : bP._data(this, "__className__") || ""
            );
          }
        }
      });
  ...
  bP.parseJSON = function (i) {
    ...
    return cd &&
      !bP.trim(
        cd.replace(a9, function (ci, cg, ch, cj) {
          if (cf && cg) {
            ce = 0;
          }
          if (ce === 0) {
  ...
  function s(ce, cf) {
    var i,
      cd,
      cg = bP.ajaxSettings.flatOptions || {};
    for (cd in cf) {
      if (cf[cd] !== undefined) {
  ...
  bP.extend({
    ...
    ajaxSettings: {
      ...
      converters: {
        "* text": String,
        "text html": true,
        "text json": bP.parseJSON,
        "text xml": bP.parseXML,
      },
    ...
    ajax: function (ch, ce) {
      ...
      var cq,
        ...
        cl = bP.ajaxSetup({}, ce),
        cz = cl.context || cl,
        co = cl.context && (cz.nodeType || cz.jquery) ? bP(cz) : bP.event,
        cy = bP.Deferred(),
        cv = bP.Callbacks("once memory"),
        cj = cl.statusCode || {},
        cp = {},
        cw = {},
        cg = 0,
      ...
      if (cl.crossDomain == null) {
        ...
        cl.crossDomain = !!(
          ...
          (cq[1] !== cb[1] ||
            cq[2] !== cb[2] ||
            (cq[3] || (cq[1] === "http:" ? "80" : "443")) !==
              (cb[3] || (cb[1] === "http:" ? "80" : "443")))
        );
      }
      ...
      if (
        (cl.data && cl.hasContent && cl.contentType !== false) ||
        ce.contentType
      ) {
      ...
      cr.setRequestHeader(
        "Accept",
        cl.dataTypes[0] && cl.accepts[cl.dataTypes[0]]
          ? cl.accepts[cl.dataTypes[0]] +
              (cl.dataTypes[0] !== "*" ? ", " + a5 + "; q=0.01" : "")
          : cl.accepts["*"]
      );
      ...
      if (
        cl.beforeSend &&
        (cl.beforeSend.call(cz, cr, cl) === false || cg === 2)
      ) {
        return cr.abort();
      }
      ck = "abort";
  ...
  bP.each(["get", "post"], function (cd, ce) {
    bP[ce] = function (i, cg, ch, cf) {
      ...
      return bP.ajax(
        bP.extend(
          { url: i, type: ce, dataType: cf, data: cg, success: ch },
          bP.isPlainObject(i) && i
        )
      );
    };
  });
  ...
  bP.expr.filters.hidden = function (i) {
    return F.reliableHiddenOffsets()
      ? i.offsetWidth <= 0 && i.offsetHeight <= 0 && !i.getClientRects().length
      : N(i);
  };
    ...
    if (bP.isArray(cg)) {
      bP.each(cg, function (ci, ch) {
        if (cd || aZ.test(ce)) {
          ...
          h(
            ce + "[" + (typeof ch === "object" && ch != null ? ci : "") + "]",
            ch,
            cd,
            cf
          );
  ...
  bP.ajaxSettings.xhr =
    bc.ActiveXObject !== undefined
      ? function () {
          ...
          return (
            (/^(get|post|head|put|delete|options)$/i.test(this.type) && bL()) ||
            bn()
          );
        }
      : bL;
  ...
  bP.ajaxTransport("script", function (ce) {
    if (ce.crossDomain) {
      var i,
        cd = m.head || bP("head")[0] || m.documentElement;
      return {
        send: function (cf, cg) {
  ...
  bP.ajaxPrefilter("json jsonp", function (cf, i, cg) {
    var ci,
      ...
      ch =
        ...
        (bf.test(cf.url)
          ? "url"
          : typeof cf.data === "string" &&
            (cf.contentType || "").indexOf(
              "application/x-www-form-urlencoded"
            ) === 0 &&
            bf.test(cf.data) &&
            "data");
    if (ch || cf.dataTypes[0] === "jsonp") {
      ci = cf.jsonpCallback = bP.isFunction(cf.jsonpCallback)
        ? cf.jsonpCallback()
        : cf.jsonpCallback;
      if (ch) {
  ...
  bP.fn.load = function (cf, ci, cj) {
    ...
    if (cd.length > 0) {
      bP.ajax({ url: cf, type: cg || "GET", dataType: "html", data: ci })
        .done(function (ck) {
          ce = arguments;
  ...
  bP.offset = {
    setOffset: function (cf, cp, cj) {
      ...
      cn = bP.css(cf, "left");
      co =
        (ck === "absolute" || ck === "fixed") &&
        bP.inArray("auto", [cd, cn]) > -1;
      if (co) {
        cl = ch.position();
        cg = cl.top;
        ci = cl.left;
        ...
        function (cg, cj, ci) {
          ...
          if (ci === undefined) {
            return ch
              ? cd in ch
                ? ch[cd]
                : ch.document.documentElement[cj]
              : cg[cj];
          }
          if (ch) {
            ch.scrollTo(
              !i ? ci : bP(ch).scrollLeft(),
              i ? ci : bP(ch).scrollTop()
            );
          } else {
            cg[cj] = ci;
          }
  ...
  bP.each({ Height: "height", Width: "width" }, function (i, cd) {
    bP.each({ padding: "inner" + i, content: cd, "": "outer" + i }, function (
      ce,
      cf
    ) {
